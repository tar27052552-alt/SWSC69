...
const regex = /transition: box-shadow \.3s var\(--ease\);\s*\}\s*letter-spacing: \.5px;\s*\}\s*\.nav-all-logos \{/m;

const replacement = `transition: box-shadow .3s var(--ease);
    }
...
console.log('Fixed CSS using regex');
